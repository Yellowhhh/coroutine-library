#ifndef __MYITEM_HOOK_H__
#define __MYITEM_HOOK_H__
#include <unistd.h>
#include <dlfcn.h>
#include <sys/types.h>
...
extern sleep_fun sleep_f;   //在头文件中extern声明了sleep_f，.cc文件中实现了这个函数，这样其他文件只要include<hook.h>就可以使用sleep_f了
                            //注意这个extern只是声明，并不会分配内存或生成代码。
